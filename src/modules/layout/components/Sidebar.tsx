...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <nav
        className="fixed top-0 left-0 w-full h-full border-r bg-white space-y-8 sm:w-80 pt-4">
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col h-full overflow-auto pt-4">
              ...
              <ul className="px-4 pb-4 text-sm font-medium">
                {
                  navsFooter.map((item, idx) => (
                    <li key={idx}>
                      <a href={item.href} onClick={item.name==="Logout" ? handleLogout :undefined} className="flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150">
                        <div className="text-gray-500">{item.icon}</div>
                        {item.name}
                      </a>
                    </li>
